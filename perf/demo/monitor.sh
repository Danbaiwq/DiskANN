...
PIPELINE_QUEUE_CAP="${PIPELINE_QUEUE_CAP:-8192}"
PIPELINE_MAX_INFLIGHT="${PIPELINE_MAX_INFLIGHT:-64}"
PIPELINE_PER_QUERY_MB="${PIPELINE_PER_QUERY_MB:-4}"
...
[demo search] PIPELINE_WORKERS : $PIPELINE_WORKERS
[demo search] PIPELINE_QUEUE_CAP : $PIPELINE_QUEUE_CAP
...
PIPELINE_QUEUE_CAP="$PIPELINE_QUEUE_CAP" \
